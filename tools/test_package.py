...
class PackageTests(unittest.TestCase):
    ...
    def test_package_includes_instructions_and_regroup_disabled_by_default(self):
        ...
        with zipfile.ZipFile(self.out) as archive:
            ...
            self.assertIn("DefianceLoader/CRASH-REPORTING.md", names)
            ...
            self.assertIn("DefianceLoader/REGROUP.md", names)
            self.assertIn("DefianceLoader/EXPANDED-AMMO.md", names)
            self.assertIn("DefianceLoader/SQUAD-SCROLL.md", names)
