// Preview weapon feature; uses the verified assembly in the shared runtime.
use defiance_api::{Api, Plugin, ABI_VERSION};
unsafe extern "C" fn init(api: *const Api) -> i32 {
    unsafe { defiance_feature_sdk::install(api, 10) }
}
#[no_mangle]
pub extern "C" fn defiance_plugin() -> *const Plugin {
    defiance_api::leak(Plugin {
        abi_version: ABI_VERSION,
        name: b"defiance.preview-weapon\0".as_ptr().cast(),
